...
const SignIn = () => {
  ...
  return (
    <div className="flex items-center text-text-dark justify-center min-h-[calc(100vh-80px)] mt-8  px-4">
      <div className="w-full max-w-md p-8 space-y-6 rounded-xl shadow-lg border border-border-gold/20 bg-bg-card/80">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-400 font-[Poppins]">
            ...
            <Link to="/signup" className="font-medium text-primary hover:text-gold">
              Sign up
            </Link>
          </p>
        </div>
