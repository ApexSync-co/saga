...
const ProductDetail = () => {
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: `Kamya Jewelry - ${product.name}`,
    ...
    return (
      <div className="min-h-screen bg-bg-primary pt-32 flex justify-center items-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-text-dark/60 text-xl font-Poppins tracking-widest uppercase">Fetching Elegance...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-transparent pt-28 pb-20">
      ...
      {/* Breadcrumbs */}
      <div className="max-w-7xl mx-auto px-6 mb-8 text-text-dark/60 text-sm font-medium">
        ...
        <span className="mx-2 text-text-dark/30">•</span>
        <span className="text-text-dark drop-shadow-sm">{product.name}</span>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[42%_58%] gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            <div className="relative group">
              <div className="aspect-[4/5] overflow-hidden rounded-[2.5rem] border border-border-gold/30 bg-bg-card/40 backdrop-blur-md shadow-2xl">
          ...
          <div className="flex flex-col space-y-6">
            <div>
              ...
              <h1 className="text-text-dark font-Great_Vibes text-4xl md:text-5xl tracking-wider font-medium leading-tight mb-2 drop-shadow-lg">
                {product.name}
              </h1>
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className={`w-4 h-4 ${
                        i < (product.rating || 5) ? 'text-primary fill-primary' : 'text-zinc-700 fill-zinc-700'
                      }`}
                      viewBox="0 0 20 20"
                    >
                ...
                <span className="text-zinc-500 text-sm font-Poppins">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-text-dark text-[10px] font-bold tracking-[0.2em] uppercase mb-2 opacity-100 flex items-center gap-3">
                    <span className="w-6 h-[1px] bg-primary"></span>
                    The Story
                </h3>
                <p className="text-text-dark/80 text-lg font-Poppins leading-relaxed drop-shadow-sm">
            ...
            <div className="pt-4 space-y-3">
              <p className="text-text-dark border-t border-border-gold/20 p-4 text-2xl font-bold font-Poppins drop-shadow-md mb-1">
                {product.price}
              </p>
                ...
                <button 
                  ...
                  className={`flex-1 group/btn relative overflow-hidden font-poppins py-6 rounded-2xl font-bold text-xl transition-all duration-700 flex items-center justify-center gap-3 shadow-2xl active:scale-95
                    ${adding 
                      ...
                      : 'bg-crimson text-white border border-border-gold/30 hover:border-primary'
                    }`}
                >
                  {adding ? (
                    <>
