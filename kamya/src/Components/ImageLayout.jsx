    ...
    return (
        <div className="md:col-span-6 md:row-span-2 relative group overflow-hidden rounded-4xl md:rounded-[2rem] min-h-[60svh] md:h-auto shadow-2xl">
            ...
            <div className="md:hidden absolute top-6 right-4 z-30 pointer-events-none">
                <h2 className="text-text-dark text-4xl tracking-wider leading-[0.8] text-right drop-shadow-lg flex flex-col gap-2">
                    <span>Heritage</span>
                    <span>Edit</span>
                </h2>
            </div>
            ...
            {carousel.map((item, index) => (
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-bg-card/40 flex flex-col justify-end p-6 md:p-10 text-text-dark">
                        <div className={`transition-all duration-1000 delay-300 transform ${
                            ...
                            <p className="text-sm md:text-base uppercase tracking-[0.2em] font-light mt-3 opacity-90 border-l-2 border-border-gold/30 pl-4">
                                {item.subtitle}
                            </p>
                        </div>
                    </div>
    ...
    return(
        <section className="w-[93vw] md:w-[85vw] lg:w-[75vw] mt-4 md:mt-0 m-auto md:py-2">
            ...
            <div className="hidden md:flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-6 md:gap-12 px-4">
                ...
                <p className="text-text-dark/60 md:max-w-[280px] lg:max-w-xs text-sm md:text-base leading-relaxed tracking-wide font-light italic border-l border-primary/30 pl-6">
            ...
            <div className="mt-4 md:mt-12 relative h-[25vh] md:h-[45vh] rounded-4xl md:rounded-[2.5rem] overflow-hidden group cursor-pointer mx-4 md:mx-0">
                ...
                <h2 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-text-dark text-center text-5xl md:text-8xl font-Great_Vibes z-20 md:group-hover:scale-105 transition-transform duration-700 pointer-events-none w-full px-4">
                    Heritage Collection
                </h2> 
                <img 
                    src={content.banner.src} 
                    alt={content.banner.alt} 
                    className="w-full h-full object-cover transform transition-transform duration-1000 md:group-hover:scale-105 border border-border-gold/10"
                    loading="lazy"
                />
            </div>
        </section>
