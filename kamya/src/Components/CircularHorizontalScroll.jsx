...
const CATEGORIES = [
  { id: 'bangles', name: 'Bangles', handle: 'bangles', image: '/Bangles.jpeg' },
        ...
        {[...categories].map((category, index) => (
          ...
          >
            ...
            <div className="w-20 h-20 md:w-38 md:h-38 rounded-full md:p-[3px] 
                            bg-bg-primary md:bg-gradient-to-br md:from-border-gold/30 md:to-border-gold/10 
              ...
              <div className="w-full h-full rounded-full overflow-hidden border-2 border-bg-primary md:border-[3px] md:border-bg-primary/50 relative bg-bg-primary">
                <img
                  src={category.image}
            ...
            <span className="text-text-dark/60 text-[9px] tracking-widest md:text-sm md:font-medium md:tracking-wider md:tracking-[0.2em] uppercase 
