   ...
   useEffect(() => {
    ...
    return(
        ...
        <Search isOpen={isSearchOpen} onClose={() => setIsSearchOpen(false)} />
            ...
            <div style={{ backgroundColor: "black" }} className={`fixed top-0 left-0 h-full w-[70vw] md:w-[30vw] bg-black text-white transform transition-transform duration-700 ease-in-out z-[100] flex flex-col shadow-2xl ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
               ...
               <ul className="flex justify-center items-center flex-col text-center text-white/80 flex-1">
                    <div className="w-full">
                        <p className="text-xs text-white/40 uppercase tracking-widest py-3 px-10 font-bold">Explore</p>
                        <Link to="/" className="w-full" onClick={() => setIsOpen(false)}>
                            <li className="cursor-pointer p-4 w-full hover:text-white hover:bg-white/5 flex items-center justify-start pl-10 gap-4 group transition-all duration-200 border-l-4 border-transparent hover:border-white/30">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 group-hover:scale-110 transition-transform text-white/70 group-hover:text-white">
                    ...
                    {isAuthenticated && (
                        <div className="w-full border-t border-primary/10">
                            <p className="text-xs text-white/40 uppercase tracking-widest py-3 px-10 font-bold">Account</p>
                    ...
                    <div className="w-full border-t border-primary/10">
                        <p className="text-xs text-white/40 uppercase tracking-widest py-3 px-10 font-bold">Support</p>
