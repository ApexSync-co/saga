...
const CATEGORIES = [
  { id: 'bangles', name: 'Bracelets', handle: 'bangles', image: '/Bangles.png' },
  { id: 'bracelets', name: 'Gold Plated', handle: 'bracelets', image: '/Bracelets.jpeg' },
  { id: 'earrings', name: 'Earrings', handle: 'earrings', image: '/stock6.JPG' },
  ...
  { id: 'sets', name: 'Sets', handle: 'sets', image: '/stock3.jpeg' },
  { id: 'blackmetal', name: 'Black Metal', handle: 'blackmetal', image: '/stock8.jpg' },
];
...
function CircularHorizontalScroll() {
  ...
  return (
    <div className="md:py-10 relative group/scroll w-full">
      ...
      <div 
        ref={scrollRef}
        className="flex overflow-x-auto md:justify-center whitespace-nowrap py-4 md:py-6 px-4 md:px-12 w-full no-scrollbar scroll-smooth gap-4 md:gap-8"
      >
