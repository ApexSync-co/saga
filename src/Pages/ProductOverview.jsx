      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {filteredAndSortedProducts.length === 0 ? (
            <div className="col-span-full py-20 px-6 text-center max-w-xl mx-auto bg-black/40 border border-white/5 rounded-3xl backdrop-blur-md shadow-2xl flex flex-col items-center">
              ...
              <p className="text-zinc-400 text-xs md:text-sm font-light leading-relaxed mb-8 max-w-sm">
                We couldn't find any products in this selection. Explore other signature collections or view our entire collection.
              </p>
