        ...
        <div className="grid grid-cols-1 lg:grid-cols-[42%_58%] gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="pt-4 space-y-3">
              ...
              {/* Store Policies */}
              <div className="mt-8 p-6 rounded-2xl border border-white/5 bg-white/5 backdrop-blur-md space-y-4">
                <h4 className="text-xs font-bold tracking-[0.2em] uppercase text-primary/95 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                  <div className="flex items-start gap-2.5 p-3 rounded-xl bg-black/40 border border-white/5">
                    ...
                    <div>
                      <p className="font-semibold text-white mb-0.5">Prepaid Only</p>
                      <p className="text-zinc-400 leading-normal">No Cash on Delivery available.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2.5 p-3 rounded-xl bg-black/40 border border-white/5">
                    <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <div>
                      <p className="font-semibold text-white mb-0.5">Kerala Shipping</p>
                      <p className="text-zinc-400 leading-normal">Currently delivering only in Kerala.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2.5 p-3 rounded-xl bg-black/40 border border-white/5">
                    <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <div>
                      <p className="font-semibold text-white mb-0.5">No Returns</p>
                      <p className="text-zinc-400 leading-normal">Final sale. Return/exchange not applicable.</p>
                    </div>
                  </div>
                </div>
              </div>
